...
class department {
    ...
    dbquery(query,print) { // this method queries db by select argument and prints the results
...
class role extends department {
    ...
    dbquery(query,print) {
        return super.dbquery(query,print);
    }
                ...
                if (err1) {
                    ...
                    inquirer
                        ...
                        .then((response) => {
                            ...
                            VALUES ("${response.empFirstName}", "${response.empLastName}", ${rowsRole[x].id}, ${rowsMgr[y].id})`, false);
